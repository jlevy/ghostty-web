 ...
 */
export declare interface HyperlinkEntry {
    uri: string;
 ...
 */
export declare function parseOsc8Sequences(data: string | Uint8Array, registry: HyperlinkRegistry): Map<number, {
    uri: string;
    id?: string;
}>;
